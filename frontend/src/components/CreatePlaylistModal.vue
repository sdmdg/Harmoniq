<template>
  <Teleport to="body">
    <div 
      v-if="isOpen" 
      class="fixed inset-0 z-[100] flex items-center justify-center bg-black bg-opacity-80 p-4"
      @click.self="$emit('close')"
    >
      <div class="bg-[#0a0a0a] rounded-xl shadow-2xl p-6 md:p-8 w-full max-w-md text-white border border-gray-700 transform transition-all scale-100 opacity-100 animate-fade-in">
        
        <div class="flex justify-between items-center mb-6">
          <h2 class="text-xl md:text-2xl font-bold text-gray-100">Create New Playlist</h2>
