...
}, { immediate: true }); // 'immediate: true' ensures the watch runs on initial component load as well
...
<!--     -->
                ...
                <RouterLink v-if="userRole == 'admin'" to="/reports">
                    <MenuItem :iconSize="24" name="Report" iconString="home" />
                </RouterLink>
                
<!--     -->   <RouterLink v-if="userRole == 'admin'" to="/adminSongsManage">
                    <MenuItem :iconSize="24" name="Songs" iconString="home" />
                </RouterLink>
                ...
                >
                    <ul class="font-semibold text-sm">
                        <RouterLink to="/profile">
                            <li class="px-3 py-2 rounded-md hover:bg-[#3e3d3d] transition-colors duration-200">Profile</li>
                        </RouterLink>
                        <div class="my-2 border-t border-t-gray-600"></div>
                        <li class="px-3 py-2 rounded-md hover:bg-[#3e3d3d] transition-colors duration-200" @click="logout">Log out</li>
                    </ul>
                </span>
            </div>
        </div>
